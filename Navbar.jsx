      ...
      <div className="relative flex justify-between items-center md:max-w-5xl md:w-fit w-full rounded-full px-6 py-3 border-[1px] border-[#8F9D91] cursor-pointer shadow-lg bg-[#DADADA] bg-opacity-10 backdrop-filter backdrop-blur-lg">
        ...
        <div className=" hidden md:flex items-center space-x-8">
          ...
          <Link
            href="/contact"
            className={`px-4 py-2 rounded-full ${
              isActive("/contact") ? "bg-white text-black" : "text-white"
            }`}
          >
            Contact
          </Link>
        ...
        {isMenuOpen && (
          <div className="absolute top-full left-0 w-full mt-2 cursor-pointer shadow-lg bg-[#DADADA] bg-opacity-100 backdrop-filter backdrop-blur-lg border-[1px] border-[#8F9D91] rounded-lg py-2 px-4 z-50">
            <ul className="flex flex-col space-y-2 text-white">
              ...
              >
                <Link onClick={toggleNavbar} href="/contact">
                  Contact
                </Link>
              </li>
